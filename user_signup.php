		...
		<div class="container">
			...
			<form action="user_signed_up.php" method="post">
				<div class="input-field">
					<input type="text" name="name" placeholder="Nombre completo" class="input-field" required>
				</div>
				<div class="input-field">
					<input type="text" name="idproof" placeholder="Clave única de registro de población" class="input-field" required>
				</div>
				<div class="input-field">
				...
				<div class="input-field">
					<input type="text" name="phone" placeholder="Número telefónico" class="input-field" required>
				</div>
				<div class="input-field">
