	...
	<body>
		...
		<div class="container">
			...
			<div style="background-color: #222; border-radius: 10px; padding: 20px; margin-top: 20px;">
				<p style="color: #fff; font-size: 18px;">Nuevo usuario creado con éxito.</p>
				<a href="user_login.php" style="color: #0FE4F1; text-decoration: none; font-size: 16px;">Iniciar sesión en mi nueva cuenta</a>
			</div>
		</div><br><br>
		<div class="footer">
