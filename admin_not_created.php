	...
	<body>
		...
		<div class="container">
			...
			<div style="background-color: #222; border-radius: 10px; padding: 20px; margin-top: 20px;">
				<p style="color: #fff; font-size: 18px;">La cuenta administrador no pudo ser creada.</p>
				<a href="index.php" style="color: #0FE4F1; text-decoration: none; font-size: 16px;">Regresar a la pagina de inicio</a>
			</div>
		</div><br><br>
		<div class="footer">
