...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			...
			<table class="basic_box">
				...
				<?php
					...
					$sql1 = "SELECT * from project_06_booked_hist";
		...
		<div class="container">
			<h2>Consultar Registro de Alojamiento</h2>
			<table class="basic_box">
				<form action="admin_room_history.php" method="post" style="display: flex; align-items: center;">
				<tr>
					<td colspan="1">Núm. Código de Reservación:</td>
					<td colspan="2">
				...
				<tr>
					<td colspan="3">
						<button type="submit" style="background-color: #184058; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; font-size: 18px; cursor: pointer; transition: background-color 0.3s;">Consultar Registro</button>
					</td>
				</tr>
				</form>
			</table>
