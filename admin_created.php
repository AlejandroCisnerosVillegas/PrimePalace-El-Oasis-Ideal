...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<h2 style="color: #fff;">Proceso de Registro</h2>
			<div style="background-color: #222; border-radius: 10px; padding: 20px; margin-top: 20px;">
				<p style="color: #fff; font-size: 18px;">Nueva cuenta administrador creada con éxito.</p>
				<a href="admin_login.php" style="color: #0FE4F1; text-decoration: none; font-size: 16px;">Iniciar sesión en mi nueva cuenta</a>
			</div>
		</div><br><br>
		<div class="footer">
