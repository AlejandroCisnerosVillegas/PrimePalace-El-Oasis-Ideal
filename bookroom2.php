...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<h2>Confirmación de Reserva de Habitación</h2>
			<div class="info-item">
				<b>¡Solicitud de Reserva de Habitación enviada exitosamente!</b>
			</div>
			<div class="info-item">
				<span>¡Ahora espera a que el Administrador confirme la solicitud!</span>
			</div>
			<a href="user_view.php" style="color: #0FE4F1; text-decoration: none; text-align: center; font-size: 20px;">Regresar a la Principal</a>
		</div>
		<div class="footer">
