...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			...
			<table class="basic_box">
				<form action="admin_room_added.php" method="post" style="display: flex; align-items: center;">
				<tr>
				...
				<tr>
					...
					<td colspan="2">
						...
						<button type="submit" style="background-color: #184058; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; font-size: 18px; cursor: pointer; transition: background-color 0.3s;">Agregar</button>
				</tr>
				</form>
			</table>
		</div>
