			...
			<div>
				...
				<table class="basic_box">
					<tr>
						...
						<td colspan="2">
						<form action="user_room_history.php" method="post" style="display: flex; align-items: center;">
							<input type="number" name="book_id" style="padding: 10px; border-radius: 5px; border: 1px solid #ccc; margin-right: 10px;">
							<button type="submit" style="background-color: #358fc4; color: #fff; padding: 10px 20px; border: none; border-radius: 5px; font-size: 18px; cursor: pointer; transition: background-color 0.3s;">Consultar Registro</button>
						</form>
					</tr>
				</table>
			</div>
