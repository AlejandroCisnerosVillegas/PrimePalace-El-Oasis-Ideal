...
<html lang="es">
	...
	<body>
		...
		<div class="container">
			<h2>Sistema de Gestión de Reservaciones</h2>
			<div class="info-item">
				<b>El sistema se encuentra con capacidad máxima en este momento.</b>
			</div>
			<p style="color: #010312; font-size: 18px;">Le solicitamos esperar hasta que haya vacantes disponibles.</p>
			<a href="admin_view.php" style="color: #0f69f1; text-decoration: none; text-align: center; font-size: 20px;">Regresar a la Principal</a>
		</div>
		<div class="footer">
